...
public interface ReportService {
    ...
    /**
     * Runs a report and gets the text output for it.
     *
     * @param baseUrl the server base url.
     * @param report the report to run.
     * @param format the format of the output. This method currently support only html
     * @return the report html output.
     */
    String getReportData(String baseUrl, Report report, String format);
    ...
    /**
     * Runs a report and gets its binary output.
     *
     * @param report the report to run.
     * @param format the format of the output. This method currently support only pdf
     * @return the report pdf output in binary format.
     */
    byte[] getReportDataBytes(String baseUrl, Report report, String format);

    byte[] getReportDataBytes(String baseUrl, Integer reportId, String format);
