...
public class WapPushSms {
	...
	public static boolean sendMessages(List<String> phoneNos, String url, String modemComPort, int modemBaudRate, String promptText){
		try{
			...
			System.out.println("Starting OpenXdata WAP Push service at com port:="+modemComPort);
			
			SerialModemGateway gateway = new SerialModemGateway("OpenXdata Gateway Modem", modemComPort, modemBaudRate, "", "",smsService);
			...
			for(String phoneNo : phoneNos){
				...
				System.out.println("Sending WAP Push Message to: "+phoneNo);
