...
public class OpenXDataConstants {
	...
	/** The tag name for the Level Tag in the HTML Log File.*/
	public static final String LOG_FILE_LEVEL_TAG_NAME = "Level";
	
	/** The tag name for the Message Tag in the HTML Log File.*/
	public static final String LOG_FILE_MESSAGE_TAG_NAME = "Message";
	
	/** The tag name for the Category Tag in the HTML Log File.*/
	public static final String LOG_FILE_CATEGORY_TAG_NAME = "category";
	
	/** The tag name for the Table Row.*/
	public static final String LOG_FILE_TABLE_ROW_TAG_NAME = "tr";
	
	/** The tag name for the Table Data.*/
	public static final String LOG_FILE_TABLE_DATA_TAG_NAME = "td";
	
	/** String to show WARN severity.*/
	public static final String LOG_FILE_WARN_STRING = "WARN";

	/** String to show ERROR severity*/
	public static final String LOG_FILE_ERROR_STRING = "ERROR";
