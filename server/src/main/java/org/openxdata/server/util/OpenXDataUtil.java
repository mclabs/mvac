...
public class OpenXDataUtil {
	...
	/**
	 * Returns the relative path to the <tt>HTML Log File.</tt>
	 * 
	 * @return the relative path to the <tt>Log File.</tt>
	 */
	public static String getHTMLLogFilePath(){
		return "openXdata Logs/openxdata-server-error.htm";
	}
}
