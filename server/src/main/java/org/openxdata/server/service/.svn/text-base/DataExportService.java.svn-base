...
/**
 * Provides services specifically needed by data export tools.
 * Such data export tools could be export to CSV, relational tables, and more.
 * 
 * @author daniel
 *
 */
public interface DataExportService {
	 ...
	 */
	List<String> getFormData(Integer formDefVersionId, Date fromDate, Date toDate, Integer userId);
