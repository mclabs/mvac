...
public class DataQuery implements Serializable {
     ...
     */
    public DataQuery(String sqlStatement, String tableName, String columnNames, String values, List<Object> parameters) {
    	this.tableName = tableName;
    	this.columnNames = columnNames;
    	this.values = values;
    	this.parameters = parameters;
    	this.sql = String.format(sqlStatement, tableName, columnNames.toString(), values.toString());
    }
