...
public class SettingServiceImpl extends OxdPersistentRemoteService implements SettingService {
	...
	@Override
	public void deleteSetting(Setting setting) throws OpenXDataException {
	...
	@Override
	public String getSetting(String name) throws OpenXDataException {
		return settingService.getSetting(name);
	}

	@Override
	public List<SettingGroup> getSettings() throws OpenXDataException {
		return settingService.getSettings();
	}

	@Override
	public void saveSetting(Setting setting) throws OpenXDataException {
