...
public class DataCheckUtil implements OnDataReturnedListener {
	...
	public void dataReturned(Boolean hasData) throws OpenXDataException {	
		if(hasData){
			...
			//TODO This message should be internationalised.
			String exMsg = "The returned result from the server cannot be discerned to " +
			"ascertain if the item has data or not";
			
			throw new OpenXDataException(exMsg);
		}
	}
