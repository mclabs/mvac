...
/**
 * Utility <code>Class</code> to encapsulate common 
 * functionality that cross cuts across all <code>View Controllers.</code> 
 * 
 * <P>Any operation to be used by more than
 * one <code>View Controller</code> should be in this <code>Class.</code></P>
 * 
 * @author Angel
 *
 */
public class MainViewControllerUtil {
	 ...
	 * 
	 * @param editable the item whose properties to set.
	 */
	 ...
	 * <p>
	 * This function is only a temporary hack for the problem of 
	 * main view widget's loading of <tt>Studies, Users, Settings </tt>etc at startup 
	 * and we have no progress window displaying leaving the <tt>User</tt> with no clue as to what is happening.
	 * </p>
	 */
	...
	public static void onSaveComplete(List<? extends Editable> modifiedList, List<? extends Editable> deletedList) {
		
		//Remove all items which have successfully been deleted from the database (have no errors)
