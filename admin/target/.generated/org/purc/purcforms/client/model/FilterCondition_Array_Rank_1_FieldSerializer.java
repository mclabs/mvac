...
public class FilterCondition_Array_Rank_1_FieldSerializer {
  ...
  public static org.purc.purcforms.client.model.FilterCondition[] instantiate(com.google.gwt.user.client.rpc.SerializationStreamReader streamReader) throws com.google.gwt.user.client.rpc.SerializationException{
    int rank = streamReader.readInt();
    return new org.purc.purcforms.client.model.FilterCondition[rank];
  }
