...
public class TaskDef_Array_Rank_1_FieldSerializer {
  ...
  public static org.openxdata.server.admin.model.TaskDef[] instantiate(com.google.gwt.user.client.rpc.SerializationStreamReader streamReader) throws com.google.gwt.user.client.rpc.SerializationException{
    int rank = streamReader.readInt();
    return new org.openxdata.server.admin.model.TaskDef[rank];
  }
