...
public class ScheduleView extends Composite {
	...
	RadioButton rdSeconds = new RadioButton(OpenXDataFacade.getOpenXDataConstants()
			.label_runevery(), OpenXDataFacade.getOpenXDataConstants().label_second());
	
	RadioButton rdMinutes = new RadioButton(OpenXDataFacade.getOpenXDataConstants()
			.label_runevery(), OpenXDataFacade.getOpenXDataConstants().label_minute());
	
	RadioButton rdHours = new RadioButton(OpenXDataFacade.getOpenXDataConstants()
			.label_runevery(), OpenXDataFacade.getOpenXDataConstants().label_hour());
	
	RadioButton rdDays = new RadioButton(
			OpenXDataFacade.getOpenXDataConstants().label_runevery(), OpenXDataFacade.getOpenXDataConstants()
					.label_day());

	RadioButton rdMonths = new RadioButton(OpenXDataFacade.getOpenXDataConstants()
			.label_runevery(), OpenXDataFacade.getOpenXDataConstants().label_month());
	...
	CheckBox chkJan = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_jan());
	CheckBox chkFeb = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_feb());
	CheckBox chkMar = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_mar());
	CheckBox chkApr = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_apr());
	CheckBox chkMay = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_may());
	CheckBox chkJun = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_jun());
	CheckBox chkJul = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_jul());
	CheckBox chkAug = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_aug());
	CheckBox chkSep = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_sep());
	CheckBox chkOct = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_oct());
	CheckBox chkNov = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_nov());
	CheckBox chkDec = new CheckBox(OpenXDataFacade.getOpenXDataConstants().month_dec());

	RadioButton rdMonthDay = new RadioButton(OpenXDataFacade.getOpenXDataConstants()
			.label_runon(), OpenXDataFacade.getOpenXDataConstants().label_dayofmonth());
	RadioButton rdWeekDay = new RadioButton(
			OpenXDataFacade.getOpenXDataConstants().label_runon(), OpenXDataFacade.getOpenXDataConstants()
					.label_dayofweek());

	RadioButton rdAllMonthWeekDays = new RadioButton(OpenXDataFacade.getOpenXDataConstants()
			.label_runon(), "All Days");

	TextBox txtMonthDay = new TextBox();

	CheckBox chkSun = new CheckBox(OpenXDataFacade.getOpenXDataConstants().day_sun());
	CheckBox chkMon = new CheckBox(OpenXDataFacade.getOpenXDataConstants().day_mon());
	CheckBox chkTue = new CheckBox(OpenXDataFacade.getOpenXDataConstants().day_tue());
	CheckBox chkWed = new CheckBox(OpenXDataFacade.getOpenXDataConstants().day_wed());
	CheckBox chkThu = new CheckBox(OpenXDataFacade.getOpenXDataConstants().day_thu());
	CheckBox chkFri = new CheckBox(OpenXDataFacade.getOpenXDataConstants().day_fri());
	CheckBox chkSat = new CheckBox(OpenXDataFacade.getOpenXDataConstants().day_sat());
	...
	ScheduleView() {
		...
		horizontalPanel.add(new Label(OpenXDataFacade.getOpenXDataConstants()
				.label_run_once_on_startup()));
		...
		horizontalPanel.add(new Label(OpenXDataFacade.getOpenXDataConstants().label_runevery()));
		...
		horizontalPanel = new HorizontalPanel();
		horizontalPanel.add(new Label(OpenXDataFacade.getOpenXDataConstants().label_at_time()));
		horizontalPanel.add(txtAtSeconds);
		horizontalPanel.add(new Label(OpenXDataFacade.getOpenXDataConstants().label_second()));
		horizontalPanel.add(txtAtMinutes);
		horizontalPanel.add(new Label(OpenXDataFacade.getOpenXDataConstants().label_minute()));
		horizontalPanel.add(txtAtHours);
		horizontalPanel.add(new Label(OpenXDataFacade.getOpenXDataConstants().label_hour()));
		horizontalPanel.setStyleName("openxdata-noborder");
		horizontalPanel.setSpacing(5);
		panel.add(horizontalPanel);

		horizontalPanel = new HorizontalPanel();
		horizontalPanel.add(new Label(OpenXDataFacade.getOpenXDataConstants().label_month()));
		...
		horizontalPanel = new HorizontalPanel();
		horizontalPanel.add(new Label(OpenXDataFacade.getOpenXDataConstants().label_on()));
		...
		horizontalPanel = new HorizontalPanel();
		horizontalPanel.add(new Label(OpenXDataFacade.getOpenXDataConstants()
				.label_custom_cron_expression()));
		horizontalPanel.add(txtCronExpression);
		txtAutoCronExpression.setEnabled(false);
		horizontalPanel.add(new Label(OpenXDataFacade.getOpenXDataConstants()
				.label_automatic_cron_expression()));
		horizontalPanel.add(txtAutoCronExpression);
		horizontalPanel.setStyleName("openxdata-noborder");
		horizontalPanel.setSpacing(5);
		advanced = new DisclosurePanel(OpenXDataFacade.getOpenXDataConstants()
				.label_advanced_schedule());
	...
	private boolean anyWeekDaySelected() {
		return ((chkSun.getValue() || chkMon.getValue() || chkTue.getValue()
				|| chkWed.getValue() || chkThu.getValue()
				|| chkFri.getValue() || chkSat.getValue()) && rdWeekDay
				.getValue());
	}

	private boolean anyMonthSelected() {
		return (chkJan.getValue() || chkFeb.getValue() || chkMar.getValue()
				|| chkApr.getValue() || chkMay.getValue()
				|| chkJun.getValue() || chkJul.getValue()
				|| chkAug.getValue() || chkSep.getValue()
				|| chkOct.getValue() || chkNov.getValue() || chkDec
				.getValue());
	}
	...
	private void updateTimeAtWidgets() {
		...
		txtAtMinutes.setEnabled(!rdMinutes.getValue()
				&& !rdSeconds.getValue() && !chkRunOnStartup.getValue());
