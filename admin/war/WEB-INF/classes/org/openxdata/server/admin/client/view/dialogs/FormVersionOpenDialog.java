...
public class FormVersionOpenDialog extends DialogBox{
	...
	private void initWidgets() {
		...
		btnCancel = new OpenXDataButton(OpenXDataFacade.getOpenXDataConstants().label_cancel());
		btnOpenReadOnly = new OpenXDataButton(OpenXDataFacade.getOpenXDataConstants().label_openreadonly());
		btnCreateNewVersion = new OpenXDataButton(OpenXDataFacade.getOpenXDataConstants().label_createnew());
		
		lblCaption = new Label(OpenXDataFacade.getOpenXDataConstants().label_formDialogpromptmessage());
		...
		vPanel.add(panel);		
		setWidget(vPanel);		
		setText(OpenXDataFacade.getOpenXDataConstants().label_formversionedittitle());
	}
