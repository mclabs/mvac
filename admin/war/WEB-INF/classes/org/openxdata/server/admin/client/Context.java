...
import org.openxdata.server.admin.client.controller.RolesViewController;
...
import org.openxdata.server.admin.client.controller.UserViewController;
import org.openxdata.server.admin.client.controller.UtilityViewController;
...
import org.openxdata.server.admin.client.service.workflow.SpecificationService;
...
public class Context implements OpenXDataObserver {
    ...
    private static SpecificationServiceAsync specificationServiceAsync;
    private static SpecStudyMapServiceAsync specStudyMapServiceAsync;
    ...
    public static void startup() {
        ...
        specificationServiceAsync = SpecificationServiceAsync.Util.getInstance();
        specStudyMapServiceAsync = SpecStudyMapServiceAsync.Util.getInstance();
    }
    ...
    public void update(OpenXDataObservable observable,
        ...
        if (modelObjects != null) {
            if (modelObjects.size() > 0) {
                if (observable.getClass() == UserViewController.class) {
                    if (modelObjects.get(0) instanceof User) {
                        Context.users = (List<User>) modelObjects;
                    }
                } else if (observable.getClass().equals(StudiesViewController.class)) {
                    if (modelObjects.get(0) instanceof StudyDef) {
                        Context.studies = (List<StudyDef>) modelObjects;
                    }
                } else if (observable.getClass().equals(RolesViewController.class)) {
                    if (modelObjects.get(0) instanceof Role) {
                        Context.roles = (List<Role>) modelObjects;
                    } else if (modelObjects.get(0) instanceof Permission) {
                        Context.permissions = (List<Permission>) modelObjects;
                    }
                ...
                } else if (observable.getClass().equals(UtilityViewController.class)) {
                    if (modelObjects.get(0) instanceof Locale) {
                        Context.locales = (List<Locale>) modelObjects;
                    }
    ...
    public static SpecificationServiceAsync getSpecificationServiceAsync()
    {
        return specificationServiceAsync;
    }

    public static SpecStudyMapServiceAsync getSpecStudyMapServiceAsync()
    {
        return specStudyMapServiceAsync;
    }
}
