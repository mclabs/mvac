...
public class OpenXDataFacade {
	...
	/**
	 * Inner <tt>class</tt> to guarantee the initialization of <tt>OpenXdataConstants variables</tt> using <tt>class initialization rules.</tt>
	 *
	 * @author Angel
	 *
	 */
	private static class FacadeHolder{
		private static OpenXdataConstants INSTANCE = (OpenXdataConstants)GWT.create(OpenXdataConstants.class);
	}
	...
	/**
	 * Return an instance of the <tt>{@link OpenXdataConstants} class.</tt>
	 * @return instance of the <tt>OpenXdataConstants class.</tt>
	 */
	public static OpenXdataConstants getOpenXDataConstants(){
