...
public interface EventDispatcher {
	...
	/**
	 * Sets the {@link AppEventListener}.
	 * <p>
	 * Note that the Application Event Listener always defaults to the {@link MainView}.
	 * </p>
	 * 
	 * @param applicationEventListener <tt>AppEventListener</tt> to set.
	 */
	void setApplicationEventListener(AppEventListener applicationEventListener);
