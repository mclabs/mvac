...
/**
 * This is a custom extension of the standard GWT DecoratedStackPanel.
 * The only reason for extending this widget is to be able to know when the panel selection changes.
 * 
 * @author daniel
 *
 */
public class OpenXDataStackPanel extends DecoratedStackPanel{
	 ...
	 * 
	 * @param stackPanelListener listener to stack panel selection events.
	 */
