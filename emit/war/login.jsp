...
<html>
  <head>
    ...
    <fmt:setBundle basename='org.celllife.emit.client.AppMessages'/>
    ...
    Ext.onReady(function(){
        ...
        var loginForm = new Ext.form.FormPanel({
            ...
            items:[{
                    id: 'message',
                    xtype: 'panel',
                    html: '<div style="text-align: center;">&nbsp;<c:if test="${!empty SPRING_SECURITY_LAST_EXCEPTION.message}"><font color="red"><fmt:message key="failedLoginMessage"/></font></c:if><c:if test="${!empty param.resetPassword}"><fmt:message key="resetPasswordMessage"/></c:if></div>'
                },{
